...
<body>
	<form action="ShoppingController" method="post">
			...
			<div id="pd">
				<table cellspacing="5">
					<tr>
						...
						<br>
						<td><input type="text" name="id" id="id" size="35" /><br>
						<br></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="textarea1" size="35" /><br>
						<br></td>
					</tr>
					<tr>
						<td><font color=black>Customer Phone:</font></td>
						<td><input type="text" name="contact" size="35"><br>
						<br></td>
					</tr>
					<tr>
						<td><font color=black>Email ID:</font></td>
						<td><input type="text" name="mail" size="35"/><br>
						<br></td>
					</tr>
					<tr>
						<td><font color=black>Password:</font></td>
						<td><input type="text" name="passwd" size="35"/><br>
						<br></td>
					</tr>
		...
		<center>
			<input type="submit" class="button" value="Update" id="submit" style="width: 212px; ">
		</center>
