...
<table cellspacing="5">
	...
	<tr>
		<td>Contact No:</td>
		<td><input type="number" id="input" name="contactno"></td>
	</tr>
	<tr>
		<td>Email:</td>
		<td><input type="email"  id="input" name="email"></td>
	</tr>
	<tr>
		<td>Password:</td>
		<td><input type="password" id="input" name="passwd"></td>
	</tr>
	<tr>
		<td>Confirm Password:</td>
		<td><input type="text" id="input" name="confirmpasswd"></td>
	</tr>
...
<center> <input type="submit" class="button" value="Register" id="submit" onclick="return validateform()">
</center>
<br>
</div>
</form>
